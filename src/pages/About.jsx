  ...
  const missionPillars = [
    {
      ...
      description: "Make Buddhist values accessible through digital platforms, learning initiatives, and community programs.",
      points: [
    ...
    },
    {
      ...
      description: "Create a unified global network of Buddha Vihars for collaboration and knowledge-sharing.",
      points: [
    ...
    },
    {
      ...
      description: "Provide a trusted, secure, and community-focused matrimonial platform exclusively for Buddhists.",
      points: [
    ...
    },
    {
      ...
      description: "Support Buddhist youth with access to skill development, career guidance, and entrepreneurship.",
      points: [
  ...
  const services = [
    {
      ...
      title: "Buddhist Matrimonial",
      description: "Trusted platform with background verification and dedicated match support for Buddhist families.",
      color: "bg-orange-500"
    },
    {
      id: 2,
      ...
      description: "Connect with Buddha Vihars worldwide for events, collaboration, and spiritual guidance.",
      color: "bg-red-500"
    },
    {
      id: 3,
      ...
      description: "Scholarships, skill training, career guidance, and quality education opportunities.",
      color: "bg-orange-500"
    },
    {
      id: 4,
      ...
      title: "Job Portal",
      description: "Internships, job placements, and professional networking for Buddhist youth.",
      color: "bg-red-500"
    },
    {
      id: 5,
      ...
      description: "Business mentoring, training, and Buddhist business network for economic empowerment.",
      color: "bg-orange-500"
    },
    {
      id: 6,
      ...
      description: "Online courses, meditation programs, and Dhamma talks for spiritual growth.",
      color: "bg-red-500"
    }
  ];
      ...
      <section className="bg-gradient-to-r from-orange-500 to-red-500 py-16 sm:py-20 md:py-28">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-white/90 max-w-4xl mx-auto mb-8">
            Merging traditional values with modern technology for holistic growth and dignity
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Our mission is to uplift the <span className="font-bold text-orange-500">Buddhist community socially, culturally, economically, and digitally</span> by merging traditional values with modern technology.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                We are ensuring that every <span className="font-bold">Buddhist family, Vihar, youth, and professional</span> is connected, empowered, and supported to achieve holistic growth and dignity.
              </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Focused areas where we make the greatest impact for the Buddhist community
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 p-8 md:p-10 rounded-2xl border border-orange-100">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Rooted in the timeless teachings of Buddha, we preserve and promote the core values that have guided our community for centuries.
              </p>
              <ul className="space-y-3">
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-orange-500 rounded-full"></span>
                  <span className="text-gray-700">Buddhist teachings (Dhamma)</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-orange-500 rounded-full"></span>
                  <span className="text-gray-700">Compassion & mindfulness</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-orange-500 rounded-full"></span>
                  <span className="text-gray-700">Community support & unity</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-orange-500 rounded-full"></span>
                ...
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-orange-500 rounded-full"></span>
                  <span className="text-gray-700">Equality & social harmony</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-8 md:p-10 rounded-2xl border border-gray-200">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Leveraging cutting-edge digital solutions to connect, empower, and support our community in the modern world.
              </p>
              <ul className="space-y-3">
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-red-500 rounded-full"></span>
                  <span className="text-gray-700">Digital platforms & apps</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-red-500 rounded-full"></span>
                ...
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-red-500 rounded-full"></span>
                  <span className="text-gray-700">Community networking tools</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-red-500 rounded-full"></span>
                  <span className="text-gray-700">Secure data & verification</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-red-500 rounded-full"></span>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Comprehensive solutions designed for the Buddhist community's needs
            </p>
          </div>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Dedicated individuals working towards community empowerment
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-orange-100 to-red-100 rounded-2xl p-8 md:p-12 text-center border border-orange-200">
            ...
            <p className="text-lg text-gray-600 mb-6 max-w-2xl mx-auto">
              We're always looking for passionate individuals who share our commitment to uplifting the Buddhist community.
            </p>
            <a 
              href="/careers" 
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition-shadow text-center">
              ...
              <p className="text-gray-600">
                Acting with kindness and understanding towards all members of our community.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition-shadow text-center">
              ...
              <p className="text-gray-600">
                Treating every individual with equal respect, dignity, and opportunity.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition-shadow text-center">
              ...
              <p className="text-gray-600">
                Building bridges within our community for collective strength and growth.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition-shadow text-center">
              ...
              <p className="text-gray-600">
                Upholding honesty and transparency in all our actions and services.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition-shadow text-center">
              ...
              <p className="text-gray-600">
                Enabling individuals and families to achieve their full potential.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition-shadow text-center">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-3">Mindfulness</h3>
              <p className="text-gray-600">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-orange-500 to-red-500">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Be part of a movement that's transforming the Buddhist community through unity, education, and digital empowerment.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="/register" 
