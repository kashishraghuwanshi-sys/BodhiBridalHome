    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-red-400 py-16 sm:py-20 md:py-28">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/register"
              className="bg-white text-red-400 font-bold py-3 px-8 rounded-lg hover:bg-gray-100 transition-colors shadow-lg"
            >
              Join Our Community
            </a>
            <a
              href="/contact"
              className="bg-transparent border-2 border-white text-white font-bold py-3 px-8 rounded-lg hover:bg-white hover:text-red-400 transition-colors"
            >
              Contact Us
            </a>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 w-32 h-32 sm:w-40 sm:h-40 bg-red-400 rounded-2xl -z-10"></div>
              <div className="absolute -top-6 -left-6 w-24 h-24 sm:w-32 sm:h-32 bg-red-300 rounded-2xl -z-10"></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {missionPillars.map((pillar) => (
              <div
                key={pillar.id}
                className="bg-white p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-t-4 border-red-400"
              >
                {/* Icon */}
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            {/* Traditional Values */}
            <div className="bg-gradient-to-br from-red-50 to-red-100 p-8 md:p-10 rounded-2xl border border-red-100">
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          {/* Combined Vision Box */}
          <div className="bg-red-400 rounded-2xl p-8 md:p-12 text-center mb-12">
            <h3 className="text-2xl sm:text-3xl font-bold text-white mb-6">
              Our Shared Vision
            </h3>
            <p className="text-lg text-white/90 mb-8 max-w-3xl mx-auto">
      ...
      {isModalOpen && selectedMember && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 md:p-8 space-y-6">
              {selectedMember.vision && (
                <div className="bg-gradient-to-r from-red-50 to-red-100 p-4 rounded-xl border-l-4 border-red-400">
            ...
            <div className="p-6 md:p-8 border-t border-gray-100 bg-gray-50 rounded-b-2xl">
              <button
                onClick={closeModal}
                className="w-full bg-red-400 hover:bg-red-500 text-white font-bold py-3 px-6 rounded-lg transition-colors"
              >
                Close
              </button>
            </div>
